...
\begin{dfnbox}{Group Homomorphism}
	Let $\alg{G; 1_G, {}^{-1}_G, \cdot_G}$ and $\alg{H; 1_H, {}^{-1}_H, \cdot_H}$ be groups. A \dfntxt{group homomorphism} is a function $f: G \to H$ satisfying the following requirements:
	\begin{dfnitems}
...
\tcblower
	\textit{Proof:} We must show that $f$ preserves the identity and inverses. For preservation of the identity, we apply preservation of products to the identity $1_G = 1_G \cdot_G 1_G$ to conclude that
...
\begin{dfnbox}{Kernel}
	Let $\alg{G; 1_G, {}^{-1}_G, \cdot_G}$ and $\alg{H; 1_H, {}^{-1}_H, \cdot_H}$ be groups, and let $f: G \to H$ be a group homomorphism. The \dfntxt{kernel} of $f$ is the subset of $G$ defined by
...
\begin{dfnbox}{Normal Subgroup, $H \normalin G$}
	Let $G$ be a group. A \dfntxt{normal subgroup} of $\alg{G; 1, {}^{-1}, \cdot}$ is a subgroup $N \le G$ satisfying the following additional requirement:
	\begin{dfnitems}
		\item \dfntxt{Closed under conjugation}: If $g \in G$ and $x \in N$, then $g x g^{-1} \in N$.
	\end{dfnitems}
\end{dfnbox}
